...
bot = TelegramClient('bandi', APP_ID, API_HASH).start(bot_token=BOT_TOKEN) 
bot2 = TelegramClient('bandi2', APP_ID, API_HASH).start(bot_token=BOT_TOKEN2) 
bot3 = TelegramClient('bandi3', APP_ID, API_HASH).start(bot_token=BOT_TOKEN3) 
bot4 = TelegramClient('bandi4', APP_ID, API_HASH).start(bot_token=BOT_TOKEN4) 
bot5 = TelegramClient('bandi5', APP_ID, API_HASH).start(bot_token=BOT_TOKEN5) 
bot6 = TelegramClient('bandi6', APP_ID, API_HASH).start(bot_token=BOT_TOKEN6) 
bot7 = TelegramClient('bandi7', APP_ID, API_HASH).start(bot_token=BOT_TOKEN7) 
bot8 = TelegramClient('bandi8', APP_ID, API_HASH).start(bot_token=BOT_TOKEN8) 
bot9 = TelegramClient('bandi9', APP_ID, API_HASH).start(bot_token=BOT_TOKEN9) 
bot10 = TelegramClient('bandi10', APP_ID, API_HASH).start(bot_token=BOT_TOKEN10)
